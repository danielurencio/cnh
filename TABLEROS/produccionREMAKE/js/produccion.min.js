$(function() {
  ...
  nombresCamposInicio.url = "https://portal.cnih.cnh.gob.mx/api/nombres_campos.py";
...
//	  if(d3.select("path#nacional")) d3.select("path#nacional").remove();
	  ...
	  obj.url = "https://portal.cnih.cnh.gob.mx/api/produccion_campos.py"
...
/// CREATE INSTANCE OF Chart OBJECT
  ...
  produccionCamposInicio.url = "https://portal.cnih.cnh.gob.mx/api/produccion_campos.py";
...
//"https://172.16.24.57/pruebas_ws/produccion_campos_html.py"
//"https://portal.cnih.cnh.gob.mx/api/produccion_campos.py"
